...
dir.create(file.path(cacheDir, "Results"), recursive = TRUE);
save(sampledLabels, file = spaste(cacheDir, "/Results/sampledLabels-run", prependZeros(runID, 3), ".RData"));
